...
public class CentrifugadorBlock extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:centrifugador")
	public static final Block block = null;
	public CentrifugadorBlock(CienticraftModElements instance) {
		super(instance, 122);
	}
