...
public class CombinadordeDNABlock extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:combinadorde_dna")
	public static final Block block = null;
	@ObjectHolder("cienticraft:combinadorde_dna")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public CombinadordeDNABlock(CienticraftModElements instance) {
		super(instance, 27);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("combinadorde_dna"));
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("combinadorde_dna");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			switch ((Direction) state.get(FACING)) {
				...
				case SOUTH :
				default :
					return VoxelShapes.create(1D, 0D, 1D, 0D, 0.7D, 0D);
				case NORTH :
					return VoxelShapes.create(0D, 0D, 0D, 1D, 0.7D, 1D);
				case WEST :
					return VoxelShapes.create(0D, 0D, 1D, 1D, 0.7D, 0D);
				case EAST :
					return VoxelShapes.create(1D, 0D, 0D, 0D, 0.7D, 1D);
			}
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("combinadorde_dna");
		}
