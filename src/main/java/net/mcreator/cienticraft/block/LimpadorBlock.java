...
public class LimpadorBlock extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:limpador")
	public static final Block block = null;
	public LimpadorBlock(CienticraftModElements instance) {
		super(instance, 96);
	}
