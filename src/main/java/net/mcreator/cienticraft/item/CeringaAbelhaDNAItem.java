...
public class CeringaAbelhaDNAItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:ceringa_abelha_dna")
	public static final Item block = null;
	public CeringaAbelhaDNAItem(CienticraftModElements instance) {
		super(instance, 57);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ceringa_abelha_dna");
		}
