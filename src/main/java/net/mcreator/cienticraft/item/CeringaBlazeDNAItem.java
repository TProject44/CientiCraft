...
public class CeringaBlazeDNAItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:ceringa_blaze_dna")
	public static final Item block = null;
	public CeringaBlazeDNAItem(CienticraftModElements instance) {
		super(instance, 58);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ceringa_blaze_dna");
		}
