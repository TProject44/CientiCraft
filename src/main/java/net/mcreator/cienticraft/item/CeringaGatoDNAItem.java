...
public class CeringaGatoDNAItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:ceringa_gato_dna")
	public static final Item block = null;
	public CeringaGatoDNAItem(CienticraftModElements instance) {
		super(instance, 59);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ceringa_gato_dna");
		}
