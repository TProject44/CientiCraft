...
public class CeringaGolfinhoDNAItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:ceringa_golfinho_dna")
	public static final Item block = null;
	public CeringaGolfinhoDNAItem(CienticraftModElements instance) {
		super(instance, 77);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ceringa_golfinho_dna");
		}
