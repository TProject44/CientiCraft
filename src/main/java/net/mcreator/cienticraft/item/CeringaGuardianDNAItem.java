...
public class CeringaGuardianDNAItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:ceringa_guardian_dna")
	public static final Item block = null;
	public CeringaGuardianDNAItem(CienticraftModElements instance) {
		super(instance, 83);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ceringa_guardian_dna");
		}
