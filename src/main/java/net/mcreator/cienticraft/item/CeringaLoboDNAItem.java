...
public class CeringaLoboDNAItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:ceringa_lobo_dna")
	public static final Item block = null;
	public CeringaLoboDNAItem(CienticraftModElements instance) {
		super(instance, 80);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ceringa_lobo_dna");
		}
