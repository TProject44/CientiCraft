...
public class CeringaMorcegoItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:ceringa_morcego")
	public static final Item block = null;
	public CeringaMorcegoItem(CienticraftModElements instance) {
		super(instance, 56);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ceringa_morcego");
		}
