...
public class CeringaTartarugaDNAItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:ceringa_tartaruga_dna")
	public static final Item block = null;
	public CeringaTartarugaDNAItem(CienticraftModElements instance) {
		super(instance, 67);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ceringa_tartaruga_dna");
		}
