...
public class CeringaaranhaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:ceringaaranha")
	public static final Item block = null;
	public CeringaaranhaItem(CienticraftModElements instance) {
		super(instance, 7);
	}
