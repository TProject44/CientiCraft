...
public class CeringacontaminadaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:ceringacontaminada")
	public static final Item block = null;
	public CeringacontaminadaItem(CienticraftModElements instance) {
		super(instance, 47);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ceringacontaminada");
		}
