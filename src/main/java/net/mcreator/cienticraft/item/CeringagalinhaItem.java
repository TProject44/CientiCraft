...
public class CeringagalinhaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:ceringagalinha")
	public static final Item block = null;
	public CeringagalinhaItem(CienticraftModElements instance) {
		super(instance, 3);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ceringagalinha");
		}
