...
public class CeringaovelhaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:ceringaovelha")
	public static final Item block = null;
	public CeringaovelhaItem(CienticraftModElements instance) {
		super(instance, 8);
	}
