...
public class SanguedeAbelhaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:sanguede_abelha")
	public static final Item block = null;
	public SanguedeAbelhaItem(CienticraftModElements instance) {
		super(instance, 61);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sanguede_abelha");
		}
