...
public class SanguedeBlazeItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:sanguede_blaze")
	public static final Item block = null;
	public SanguedeBlazeItem(CienticraftModElements instance) {
		super(instance, 62);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sanguede_blaze");
		}
