...
public class SanguedeCrepeerItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:sanguede_crepeer")
	public static final Item block = null;
	public SanguedeCrepeerItem(CienticraftModElements instance) {
		super(instance, 72);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sanguede_crepeer");
		}
