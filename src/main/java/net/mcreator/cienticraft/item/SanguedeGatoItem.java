...
public class SanguedeGatoItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:sanguede_gato")
	public static final Item block = null;
	public SanguedeGatoItem(CienticraftModElements instance) {
		super(instance, 63);
	}
