...
public class SanguedeGolfinhoItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:sanguede_golfinho")
	public static final Item block = null;
	public SanguedeGolfinhoItem(CienticraftModElements instance) {
		super(instance, 78);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sanguede_golfinho");
		}
