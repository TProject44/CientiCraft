...
public class SanguedeGuardianItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:sanguede_guardian")
	public static final Item block = null;
	public SanguedeGuardianItem(CienticraftModElements instance) {
		super(instance, 84);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sanguede_guardian");
		}
