...
public class SanguedeLoboItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:sanguede_lobo")
	public static final Item block = null;
	public SanguedeLoboItem(CienticraftModElements instance) {
		super(instance, 81);
	}
