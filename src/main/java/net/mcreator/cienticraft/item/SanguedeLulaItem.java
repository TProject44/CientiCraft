...
public class SanguedeLulaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:sanguede_lula")
	public static final Item block = null;
	public SanguedeLulaItem(CienticraftModElements instance) {
		super(instance, 75);
	}
