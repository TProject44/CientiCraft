...
public class SanguedeMorcegoItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:sanguede_morcego")
	public static final Item block = null;
	public SanguedeMorcegoItem(CienticraftModElements instance) {
		super(instance, 60);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sanguede_morcego");
		}
