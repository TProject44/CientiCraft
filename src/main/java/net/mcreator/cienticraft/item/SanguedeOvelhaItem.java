...
public class SanguedeOvelhaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:sanguede_ovelha")
	public static final Item block = null;
	public SanguedeOvelhaItem(CienticraftModElements instance) {
		super(instance, 44);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sanguede_ovelha");
		}
