...
public class SanguezumbiItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:sanguezumbi")
	public static final Item block = null;
	public SanguezumbiItem(CienticraftModElements instance) {
		super(instance, 38);
	}
