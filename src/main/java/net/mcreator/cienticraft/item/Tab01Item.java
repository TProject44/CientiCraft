...
public class Tab01Item extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tab_01")
	public static final Item block = null;
	public Tab01Item(CienticraftModElements instance) {
		super(instance, 68);
	}
