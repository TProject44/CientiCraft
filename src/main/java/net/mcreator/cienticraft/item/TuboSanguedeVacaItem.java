...
public class TuboSanguedeVacaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubo_sanguede_vaca")
	public static final Item block = null;
	public TuboSanguedeVacaItem(CienticraftModElements instance) {
		super(instance, 64);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tubo_sanguede_vaca");
		}
