...
public class TuboabelhaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tuboabelha")
	public static final Item block = null;
	public TuboabelhaItem(CienticraftModElements instance) {
		super(instance, 87);
	}
