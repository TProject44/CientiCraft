...
public class TuboaranhaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tuboaranha")
	public static final Item block = null;
	public TuboaranhaItem(CienticraftModElements instance) {
		super(instance, 20);
	}
