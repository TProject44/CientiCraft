...
public class TuboblazeItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tuboblaze")
	public static final Item block = null;
	public TuboblazeItem(CienticraftModElements instance) {
		super(instance, 88);
	}
