...
public class TubocomSanguedeCrepeerItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubocom_sanguede_crepeer")
	public static final Item block = null;
	public TubocomSanguedeCrepeerItem(CienticraftModElements instance) {
		super(instance, 73);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tubocom_sanguede_crepeer");
		}
