...
public class TubocomSanguedeGalinhaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubocom_sanguede_galinha")
	public static final Item block = null;
	public TubocomSanguedeGalinhaItem(CienticraftModElements instance) {
		super(instance, 65);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tubocom_sanguede_galinha");
		}
