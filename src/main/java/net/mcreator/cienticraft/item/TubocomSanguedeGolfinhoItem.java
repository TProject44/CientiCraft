...
public class TubocomSanguedeGolfinhoItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubocom_sanguede_golfinho")
	public static final Item block = null;
	public TubocomSanguedeGolfinhoItem(CienticraftModElements instance) {
		super(instance, 79);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tubocom_sanguede_golfinho");
		}
