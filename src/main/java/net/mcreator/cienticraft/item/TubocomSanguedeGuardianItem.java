...
public class TubocomSanguedeGuardianItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubocom_sanguede_guardian")
	public static final Item block = null;
	public TubocomSanguedeGuardianItem(CienticraftModElements instance) {
		super(instance, 85);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tubocom_sanguede_guardian");
		}
