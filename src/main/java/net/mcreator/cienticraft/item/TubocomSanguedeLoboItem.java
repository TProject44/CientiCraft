...
public class TubocomSanguedeLoboItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubocom_sanguede_lobo")
	public static final Item block = null;
	public TubocomSanguedeLoboItem(CienticraftModElements instance) {
		super(instance, 82);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tubocom_sanguede_lobo");
		}
