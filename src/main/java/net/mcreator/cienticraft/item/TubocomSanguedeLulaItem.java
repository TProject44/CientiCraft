...
public class TubocomSanguedeLulaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubocom_sanguede_lula")
	public static final Item block = null;
	public TubocomSanguedeLulaItem(CienticraftModElements instance) {
		super(instance, 76);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tubocom_sanguede_lula");
		}
