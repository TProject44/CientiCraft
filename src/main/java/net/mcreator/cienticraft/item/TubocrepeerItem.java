...
public class TubocrepeerItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubocrepeer")
	public static final Item block = null;
	public TubocrepeerItem(CienticraftModElements instance) {
		super(instance, 90);
	}
