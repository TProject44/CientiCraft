...
public class TubogatoItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubogato")
	public static final Item block = null;
	public TubogatoItem(CienticraftModElements instance) {
		super(instance, 89);
	}
