...
public class TubogolfinhoItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubogolfinho")
	public static final Item block = null;
	public TubogolfinhoItem(CienticraftModElements instance) {
		super(instance, 91);
	}
