...
public class TuboloboItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubolobo")
	public static final Item block = null;
	public TuboloboItem(CienticraftModElements instance) {
		super(instance, 94);
	}
