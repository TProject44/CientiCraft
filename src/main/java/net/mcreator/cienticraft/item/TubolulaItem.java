...
public class TubolulaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubolula")
	public static final Item block = null;
	public TubolulaItem(CienticraftModElements instance) {
		super(instance, 93);
	}
