...
public class TubomorcegoItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubomorcego")
	public static final Item block = null;
	public TubomorcegoItem(CienticraftModElements instance) {
		super(instance, 86);
	}
