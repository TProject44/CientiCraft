...
public class TubopandaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubopanda")
	public static final Item block = null;
	public TubopandaItem(CienticraftModElements instance) {
		super(instance, 24);
	}
