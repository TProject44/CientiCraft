...
public class TubovacaItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubovaca")
	public static final Item block = null;
	public TubovacaItem(CienticraftModElements instance) {
		super(instance, 16);
	}
