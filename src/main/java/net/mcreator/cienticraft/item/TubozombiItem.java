...
public class TubozombiItem extends CienticraftModElements.ModElement {
	@ObjectHolder("cienticraft:tubozombi")
	public static final Item block = null;
	public TubozombiItem(CienticraftModElements instance) {
		super(instance, 23);
	}
