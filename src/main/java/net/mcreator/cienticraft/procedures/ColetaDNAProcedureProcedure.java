...
import net.mcreator.cienticraft.item.CeringazombiItem;
...
import net.mcreator.cienticraft.item.CeringapandaItem;
...
import net.mcreator.cienticraft.item.CeringaFoxItem;
		...
		if (((((sourceentity instanceof LivingEntity) ? ((LivingEntity) sourceentity).getHeldItemMainhand() : ItemStack.EMPTY)
			...
			if (sourceentity instanceof PlayerEntity)
				((PlayerEntity) sourceentity).inventory.clearMatchingItems(
						...
						(int) 1);
			if (sourceentity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(CeringazombiItem.block, (int) (1));
				_setstack.setCount((int) 1);
				ItemHandlerHelper.giveItemToPlayer(((PlayerEntity) sourceentity), _setstack);
			}
			entity.attackEntityFrom(DamageSource.GENERIC, (float) 2);
		...
		if (((((sourceentity instanceof LivingEntity) ? ((LivingEntity) sourceentity).getHeldItemMainhand() : ItemStack.EMPTY)
			...
			if (sourceentity instanceof PlayerEntity)
				((PlayerEntity) sourceentity).inventory.clearMatchingItems(
						...
						(int) 1);
			if (sourceentity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(CeringapandaItem.block, (int) (1));
				_setstack.setCount((int) 1);
				ItemHandlerHelper.giveItemToPlayer(((PlayerEntity) sourceentity), _setstack);
			}
			entity.attackEntityFrom(DamageSource.GENERIC, (float) 2);
		...
		if (((((sourceentity instanceof LivingEntity) ? ((LivingEntity) sourceentity).getHeldItemMainhand() : ItemStack.EMPTY)
			...
			if (sourceentity instanceof PlayerEntity)
				((PlayerEntity) sourceentity).inventory.clearMatchingItems(
						...
						(int) 1);
			if (sourceentity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(CeringaFoxItem.block, (int) (1));
				_setstack.setCount((int) 1);
				ItemHandlerHelper.giveItemToPlayer(((PlayerEntity) sourceentity), _setstack);
			}
			entity.attackEntityFrom(DamageSource.GENERIC, (float) 2);
